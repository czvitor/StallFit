...
public final class WorkoutSessionDao_Impl implements WorkoutSessionDao {
  ...
  public WorkoutSessionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfWorkoutSessionEntity = new EntityInsertionAdapter<WorkoutSessionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `workout_sessions` (`id`,`name`,`startedAt`,`finishedAt`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfWorkoutSessionEntity = new EntityDeletionOrUpdateAdapter<WorkoutSessionEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `workout_sessions` SET `id` = ?,`name` = ?,`startedAt` = ?,`finishedAt` = ? WHERE `id` = ?";
      }
      ...
      public WorkoutSessionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new WorkoutSessionEntity(_tmpId,_tmpName,_tmpStartedAt,_tmpFinishedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Flow<WorkoutSessionEntity> getActiveSession() {
    final String _sql = "SELECT * FROM workout_sessions WHERE finishedAt IS NULL ORDER BY startedAt DESC LIMIT 1";
      ...
      public List<WorkoutSessionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new WorkoutSessionEntity(_tmpId,_tmpName,_tmpStartedAt,_tmpFinishedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
