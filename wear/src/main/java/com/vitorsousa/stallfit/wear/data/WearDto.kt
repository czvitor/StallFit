...
/**
 * Wire DTOs for the watch<->phone protocol. Mirrored by hand from the `:app` module — see that
 * module's `data/wear/WearDto.kt` — instead of a shared `:common` module, kept deliberately small.
 */
@Serializable
